...
,toolbars:[["InsertUnorderedList","InsertOrderedList","Unlink","Link","SelectAll","Preview","Source","InsertImage","Emotion","InsertVideo","Attachment","Map","Spechars","BlockQuote","Bold","Italic","Underline","StrikeThrough","ForeColor","BackColor","JustifyLeft","JustifyCenter","JustifyRight","JustifyJustify","Indent","PastePlain","Paragraph","RowSpacingBottom","RowSpacingTop","LineHeight","FontFamily","FontSize","ImageNone","ImageLeft","ImageRight","ImageCenter","InsertTable","DeleteTable","MergeRight","MergeDown","SplittoRows","SplittoCols","SplittoCells","MergeCells","InsertCol","InsertRow","DeleteCol","DeleteRow","InsertParagraphBeforeTable"]]
//当鼠标放在工具栏上时显示的tooltip提示
,labelMap:{'insertunorderedlist':'','insertorderedlist':'','unlink':'','link':'','selectall':'','preview':'','source':'','insertimage':'','emotion':'','insertvideo':'','attachment':'','map':'','spechars':'','blockquote':'','bold':'','italic':'','underline':'','strikethrough':'','forecolor':'','backcolor':'','justifyleft':'','justifycenter':'','justifyright':'','justifyjustify':'','indent':'','pasteplain':'','paragraph':'','rowspacingbottom':'','rowspacingtop':'','lineheight':'','fontfamily':'','fontsize':'','imagenone':'','imageleft':'','imageright':'','imagecenter':'','inserttable':'','deletetable':'','mergeright':'','mergedown':'','splittorows':'','splittocols':'','splittocells':'','mergecells':'','insertcol':'','insertrow':'','deletecol':'','deleterow':'','insertparagraphbeforetable':''}
...
,initialFrameWidth:"100%"  //初始化编辑器宽度,默认1000，设置为100%,使其自适应大小
...
,textarea:"post_content"  // 提交表单时，服务器获取编辑器提交内容的所用的参数，多实例时可以给容器name属性，会将name给定的值最为每个实例的键值，不用每次实例化的时候都设置这个值
